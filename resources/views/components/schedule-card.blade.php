<div class="inline-flex items-center justify-start w-full px-4 py-4 bg-white shadow-md rounded-xs lg:flex-col lg:px-8 lg:py-16 lg:h-auto lg:rounded-md">
    ...
    <div class="lg:text-center lg:mt-4 max-lg:ms-4">
        <h3 class="font-black tracking-wide text-primary-700 text-subtitle">{{ $schedule->date->translatedFormat('l, j F Y') }}</h3>
        <p class="mt-2 font-semibold max-xl:text-detail">{{ $schedule->title }}</p>
    </div>
</div>
