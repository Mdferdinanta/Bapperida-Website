        ...
        @if ($leftNews)
            <div class="relative overflow-hidden rounded-xs max-sm:aspect-video sm:h-96 lg:h-[400px] lg:basis-1/2 group">
                <a href="{{ route('news-preview', ['id' => $leftNews->id]) }}" wire:navigate>
                    ...
                    <div
                        class="absolute bottom-0 flex flex-col w-full gap-2 p-4 bg-gray-900 bg-opacity-80 transition-transform transform translate-y-9 group-hover:translate-y-0">
                        <small
                        ...
                        <span class="font-semibold tracking-wide text-justify text-gray-200 max-sm:text-detail">Lihat
        ...
        <div class="flex flex-wrap gap-4 max-sm:flex-col rounded-xs lg:basis-1/2">
            ...
            @foreach ($rightNews as $item)
                <div
                    ...
                    <div
                        class="absolute bottom-0 flex flex-col w-full gap-2 px-4 py-2 bg-gray-900 bg-opacity-80 transition-transform transform translate-y-6 cursor-pointer group-hover:translate-y-0">
                        <small
